      ...
      <CardContent className="space-y-5 p-5 md:p-6">
        ...
        <div className="flex flex-col gap-4 pt-2">
           <div className="flex gap-3">
              ...
              <Button 
                variant="tonal" 
                className={`flex-1 rounded-xl h-11 ${useFuelStationsStore((state) => state.confirmedStationIds).includes(station.id) ? "bg-emerald-500/20 text-emerald-600 cursor-default" : ""}`}
