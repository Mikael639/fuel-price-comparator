            ...
            <div className="space-y-3 flex-1">
              <div className="flex flex-wrap gap-2">
                ...
                {station.priceTrend !== "stable" && (
                  <Badge variant="outline" className={`animate-pulse-subtle border-none font-bold ${station.priceTrend === "down" ? "bg-emerald-500/20 text-emerald-600 dark:text-emerald-400" : "bg-red-500/20 text-red-600 dark:text-red-400"}`}>
                    {station.priceTrend === "down" ? "BAISSE PRÉVUE" : "HAUSSE PRÉVUE"}
                  </Badge>
                )}
                {stale && (
