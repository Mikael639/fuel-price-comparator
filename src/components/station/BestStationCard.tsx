      ...
      <CardContent className="relative grid gap-6 p-6 md:grid-cols-[minmax(0,1fr)_18rem] md:p-8">
        <div className="space-y-6">
          <div className="flex flex-wrap gap-2">
            <Badge variant="accent" className="bg-amber-400 text-slate-900 border-none font-bold px-3 py-1 scale-110 origin-left">
              RECOMMENDÉE
            </Badge>
          ...
          <div className="flex items-center gap-4">
            <div className="space-y-1">
              ...
              <h3 className="font-display text-4xl tracking-tight leading-tight">{station.name}</h3>
          ...
          <div className="space-y-4 pt-2">
            <div className="flex flex-wrap gap-3">
              <Button 
                ...
                variant="secondary"
                className="bg-white/10 hover:bg-white/20 border-white/10 text-white rounded-xl h-12 px-6"
              >
              ...
              <Button 
                ...
                variant="ghost"
                className="text-white hover:bg-white/10 rounded-xl h-12 w-12 p-0"
              >
            ...
            <div className="space-y-2">
              ...
              <NavigationMenu lat={station.lat} lng={station.lng} />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between rounded-[28px] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest leading-none mb-1">Économie</p>
            ...
            {netSavings && netSavings > 0 && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest leading-none mb-1">Gain net estimé</p>
