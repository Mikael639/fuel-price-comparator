...
// Fallback data — Weekly Oil Bulletin Commission européenne (bulletin n°2312, semaine du 23 juin 2026)
// Contexte : guerre en Iran (déclenchée le 28/02/2026) → pic diesel en avril, baisse progressive post-cessez-le-feu (mai-juin).
...
export const europeFuelMarkets: EuropeFuelMarket[] = [
  {
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 2.07, SP95: 2.06, E85: 0.87, GPL: 0.95 } },
      { date: "2026-06-09", prices: { Diesel: 2.04, SP95: 2.04, E85: 0.87, GPL: 0.95 } },
      { date: "2026-06-16", prices: { Diesel: 2.01, SP95: 2.02, E85: 0.86, GPL: 0.94 } },
      { date: "2026-06-23", prices: { Diesel: 1.98, SP95: 2.00, E85: 0.86, GPL: 0.94 } },
    ],
  },
  {
    code: "BE",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.97, SP95: 1.90, SP98: 1.99 } },
      { date: "2026-06-09", prices: { Diesel: 1.95, SP95: 1.89, SP98: 1.98 } },
      { date: "2026-06-16", prices: { Diesel: 1.93, SP95: 1.88, SP98: 1.97 } },
      { date: "2026-06-23", prices: { Diesel: 1.91, SP95: 1.87, SP98: 1.96 } },
    ],
  },
  {
    code: "DE",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.93, SP95: 1.93, SP98: 2.02 } },
      { date: "2026-06-09", prices: { Diesel: 1.91, SP95: 1.92, SP98: 2.01 } },
      { date: "2026-06-16", prices: { Diesel: 1.89, SP95: 1.91, SP98: 2.00 } },
      { date: "2026-06-23", prices: { Diesel: 1.87, SP95: 1.90, SP98: 1.99 } },
    ],
  },
  {
    code: "ES",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.61, SP95: 1.70, SP98: 1.78 } },
      { date: "2026-06-09", prices: { Diesel: 1.59, SP95: 1.69, SP98: 1.77 } },
      { date: "2026-06-16", prices: { Diesel: 1.57, SP95: 1.68, SP98: 1.76 } },
      { date: "2026-06-23", prices: { Diesel: 1.55, SP95: 1.67, SP98: 1.75 } },
    ],
  },
  {
    code: "IT",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.98, SP95: 1.99, SP98: 2.08 } },
      { date: "2026-06-09", prices: { Diesel: 1.96, SP95: 1.97, SP98: 2.06 } },
      { date: "2026-06-16", prices: { Diesel: 1.93, SP95: 1.95, SP98: 2.04 } },
      { date: "2026-06-23", prices: { Diesel: 1.91, SP95: 1.93, SP98: 2.02 } },
    ],
  },
  {
    code: "NL",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 2.24, SP95: 2.38, SP98: 2.51 } },
      { date: "2026-06-09", prices: { Diesel: 2.22, SP95: 2.36, SP98: 2.49 } },
      { date: "2026-06-16", prices: { Diesel: 2.20, SP95: 2.34, SP98: 2.47 } },
      { date: "2026-06-23", prices: { Diesel: 2.18, SP95: 2.32, SP98: 2.45 } },
    ],
  },
  {
    code: "PT",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.70, SP95: 1.75, SP98: 1.83 } },
      { date: "2026-06-09", prices: { Diesel: 1.68, SP95: 1.74, SP98: 1.82 } },
      { date: "2026-06-16", prices: { Diesel: 1.66, SP95: 1.73, SP98: 1.81 } },
      { date: "2026-06-23", prices: { Diesel: 1.64, SP95: 1.72, SP98: 1.80 } },
    ],
  },
  {
    code: "LU",
    ...
    snapshots: [
      ...
      { date: "2026-06-02", prices: { Diesel: 1.55, SP95: 1.57, SP98: 1.65 } },
      { date: "2026-06-09", prices: { Diesel: 1.53, SP95: 1.56, SP98: 1.64 } },
      { date: "2026-06-16", prices: { Diesel: 1.51, SP95: 1.55, SP98: 1.63 } },
      { date: "2026-06-23", prices: { Diesel: 1.50, SP95: 1.54, SP98: 1.62 } },
    ],
  },
];
