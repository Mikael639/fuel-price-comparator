...
const { nearbyStations, selectedFuel } = storeToRefs(stationStore);
</script>
  ...
  <v-container class="py-6 py-md-8">
    <section class="mb-6">
      <v-card class="page-hero pa-5 pa-md-7">
        <SectionHeading
          eyebrow="Europe"
          subtitle="Comparez les lectures hebdomadaires de plusieurs marches europeens sans surcharger la page d'accueil."
          title="Panorama europeen carburants"
        />
      </v-card>
    </section>
